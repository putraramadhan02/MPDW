...
```{r}
par(mfrow = c(1, 2))
ts.plot(arma22_manual, main="Plot Time Series ARMA(2,2) Manual", ylab="Yt")
ts.plot(arma22_sim, main="Plot Time Series ARMA(2,2) Arima.sim", ylab="Yt")
par(mfrow = c(1, 1))
```
...
```{r}
par(mfrow = c(1, 2))
acf(arma22_manual, main="Plot Time Series ARMA(2,2) Manual", ylab="Yt")
acf(arma22_sim, main="Plot Time Series ARMA(2,2) Arima.sim", ylab="Yt")
par(mfrow = c(1, 1))
```
...
```{r}
par(mfrow = c(1, 2))
pacf(arma22_manual, main="Plot Time Series ARMA(2,2) Manual", ylab="Yt")
pacf(arma22_sim, main="Plot Time Series ARMA(2,2) Arima.sim", ylab="Yt")
par(mfrow = c(1, 1))
```
